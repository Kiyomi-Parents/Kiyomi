...
async def setup(bot: Kiyomi):
    ...
    await bot.add_cog(Settings(bot, setting_service, settings_autocomplete_service))
    await bot.add_cog(SettingsAPI(bot, setting_service, settings_autocomplete_service, uow))
