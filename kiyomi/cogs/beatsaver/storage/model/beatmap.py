...
from kiyomi.database import Base, EMapTagList
...
class Beatmap(Base):
    ...
    versions = relationship("BeatmapVersion", back_populates="beatmap", cascade="all, delete-orphan", lazy="joined", join_depth=4)
