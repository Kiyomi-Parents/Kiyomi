...
class IntegerSetting(AbstractRegularSetting[int]):
    ...
    def create(
        ...
        return IntegerSetting(group, name_human, Setting(None, SettingType.INT, name, default_value), permissions)
    ...
    def get_from_setting(group: str, name_human: str, setting: Setting, permissions: Optional[Permissions] = None):
        ...
        return IntegerSetting(group, name_human, setting, permissions)
